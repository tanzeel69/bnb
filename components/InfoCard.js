...
const InfoCard = ({img, location, title, description, star, price, total}) => {
    return (
        <div className="flex py-7 px-2 first:border-t border-b
        cursor-pointer hover:opacity-75 hover:shadow-lg pr-4
        transition duration-200 ease-out">
            <div className="relative h-34 w-40 md:h-52 md:w-80
            flex-shrink-0">
